<template>
	<div class="reader-menu-container">
      ...
      <mu-icon value="arrow_back_ios" @click="back()" style="vertical-align: middle;padding-left: 20px">
      </mu-icon>
		</div>
		<div  v-show="isMenuShow" class="reader-menu-bottom fix">
			<a @click="showcatlog"  class="reader-menu-tabs reader-menu-toc" href="javascript:">
        <mu-icon  class="reader-icon-tabs"value="book">
          目录
        </mu-icon>
      </a>
			<a @click="fontmenu" class="reader-menu-tabs reader-menu-font" href="javascript:">
        <mu-icon class="reader-icon-tabs" value="settings">
          设置
        </mu-icon>
      </a>
			<a @click="showsources" class="reader-menu-tabs reader-menu-source" href="javascript:">
        <mu-icon class="reader-icon-tabs" value="language">
          换源
        </mu-icon>
      </a>
			<a @click="nightmode" class="reader-menu-tabs reader-menu-night" href="javascript:">
