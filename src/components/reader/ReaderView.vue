...
<transition name="readerslide">
	<div class="reader-container" @touchstart="checkStart" @touchmove="checkmove" @touchend="oprationAction">
			<reader-content :bookContent='chapterContent' :Title="Title">
      </reader-content>
			<reader-menu @prev="chapterUp" @next="chapterDown" :isMenuShow="ismenushow" :Now="currentChapter+1" :Total="Total">
      </reader-menu>
			<reader-catalog @ChangeSource="changeSource" @ChangeChapter="goChapter" :catlog="chapters" :sources="sources" :Total="Total">
      </reader-catalog>
	</div>
</transition>
</template>
