<template>
  <div class="index-container">
    ...
    <div class="index-main-box">
      <m-head  :menubtn="true" :title="'阅读器'" :center="true">
      </m-head>
      <div class="index-scroll-view" ref="indexview">
        <indexMale :malelist="malelist">
        </indexMale>
        <indexFemale :femalelist="femalelist">
        </indexFemale>
        <indexNewbook :newslist="newslist">
        </indexNewbook>
      </div>
    </div>
    </keep-alive>
...
<script>
  ...
  import indexMale from '../pages/MaleIndex'
  import indexFemale from '../pages/FemaleIndex'
  import indexNewbook from "../pages/NewBookIndex"
